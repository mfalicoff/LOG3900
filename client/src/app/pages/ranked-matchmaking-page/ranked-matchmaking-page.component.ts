...
export class RankedMatchmakingPageComponent {
    ...
    constructor(public userService: UserService , public timerService: TimerService, private socketService: SocketService,
        public infoClientService: InfoClientService, public rankedService:RankedService) {
